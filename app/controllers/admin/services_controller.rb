class Admin::ServicesController < Admin::AdminController
  ...
  def create
    ...
    respond_to do |format|
      if @admin_service.save
        format.html { redirect_to admin_services_path, notice: 'Salvo com sucesso.' }
  ...
  private
    ...
    def admin_service_params
      params.require(:admin_service).permit(:name, :description, :image, :retained_image, :remove_image)
    end
end
